...
public interface IReadableContext<ElementType> extends IContext<ElementType>, Iterable<ElementType> {
	 ...
	 */
	<TargetContextType extends IModifyableContext<ElementType>> TargetContextType lookup(
			Predicate<ElementType> pPredicate, TargetContextType pTarget);
	 ...
	 */
	<TargetContextType extends IModifyableContext<ElementType>> TargetContextType lookup(
			Predicate<ElementType> pPredicate, int pMaxCount, TargetContextType pTarget);
